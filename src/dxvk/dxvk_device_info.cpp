...
namespace dxvk {
  ...
  std::vector<DxvkDeviceCapabilities::FeatureEntry> DxvkDeviceCapabilities::getFeatureList() {
    ...
    return {{
      ENABLE_FEATURE(core.features, depthBiasClamp, false),
      ENABLE_FEATURE(core.features, depthBounds, false),
      ENABLE_FEATURE(core.features, depthClamp, false),
      ...
      ENABLE_FEATURE(core.features, fullDrawIndexUint32, false),
      ...
      ENABLE_FEATURE(core.features, robustBufferAccess, false),
      ENABLE_FEATURE(core.features, sampleRateShading, false),
      ENABLE_FEATURE(core.features, samplerAnisotropy, false),
      ENABLE_FEATURE(core.features, shaderClipDistance, false),
      ENABLE_FEATURE(core.features, shaderCullDistance, false),
      ENABLE_FEATURE(core.features, shaderFloat64, false),
      ENABLE_FEATURE(core.features, shaderImageGatherExtended, false),
      ...
      ENABLE_FEATURE(core.features, shaderSampledImageArrayDynamicIndexing, false),
      ...
      ENABLE_FEATURE(vk11, shaderDrawParameters, false),
      ENABLE_FEATURE(vk11, storageBuffer16BitAccess, false),
      ENABLE_FEATURE(vk11, storagePushConstant16, false),

      ENABLE_FEATURE(vk12, bufferDeviceAddress, false),
      ENABLE_FEATURE(vk12, descriptorIndexing, false),
      ENABLE_FEATURE(vk12, storageBuffer8BitAccess, false),
      ...
      ENABLE_FEATURE(vk12, descriptorBindingSampledImageUpdateAfterBind, false),
      ENABLE_FEATURE(vk12, descriptorBindingUpdateUnusedWhilePending, false),
      ENABLE_FEATURE(vk12, descriptorBindingPartiallyBound, false),
      ...
      ENABLE_FEATURE(vk12, timelineSemaphore, false),
      ...
      ENABLE_FEATURE(vk13, dynamicRendering, false),
